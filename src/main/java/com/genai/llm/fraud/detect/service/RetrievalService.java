...
public class RetrievalService 
{
	...
	{	
		...
		{	//user supplied dynamic values
			contextType = getContextTypeDynamic(contextType, text);
	...
	private String getContextTypeDynamic(String contextType, String text) 
	{	
		contextType = null; // extract from the user prompt
		String result = contextType;
